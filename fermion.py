...
def diagonalize_fermionic_hamiltonian(
    ...
    *,
    ...
    Args:
        ...
        circuit: the circuit from which the data was generated
        trajectory_count: the number of trajectories to use to generate true probabilities
        pool_size: the total number of bitstrings; only applicable for fe2s2 optimal, None otherwise
        match_idx: the indices for which to subsample according to true probabilities (and use the matchgate simulator)
        choose_best: choose highest probability bitstrings instead of subsampling according to true probabilities
    ...
    for current_iteration in range(max_iterations):
        ...
        if current_iteration in match_idx:
            use_match = True
        ...
        subsamples = subsample(
            ...
            choose_best=(choose_best and use_match),
            rand_seed=rng,
        )
