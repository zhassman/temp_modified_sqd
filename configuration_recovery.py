...
def recover_configurations(
    ...
    if return_true_probs:
        ...
        bs_mat_out = np.array([[bit == "1" for bit in bs] for bs in keys])
        ints_out = np.array([int(bs, 2) for bs in keys])
